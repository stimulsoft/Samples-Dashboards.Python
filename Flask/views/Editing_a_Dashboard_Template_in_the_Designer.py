...
Editing_a_Dashboard_Template_in_the_Designer = app = Blueprint('Editing_a_Dashboard_Template_in_the_Designer', __name__)


@app.route('/Editing_a_Dashboard_Template_in_the_Designer', methods = ['GET', 'POST'])
def index():
