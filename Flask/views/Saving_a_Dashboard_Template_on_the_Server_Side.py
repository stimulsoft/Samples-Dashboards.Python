...
Saving_a_Dashboard_Template_on_the_Server_Side = app = Blueprint('Saving_a_Dashboard_Template_on_the_Server_Side', __name__)
...
@app.route('/Saving_a_Dashboard_Template_on_the_Server_Side', methods = ['GET', 'POST'])
def index():
