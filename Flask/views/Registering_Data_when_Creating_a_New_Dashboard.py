...
Registering_Data_when_Creating_a_New_Dashboard = app = Blueprint('Registering_Data_when_Creating_a_New_Dashboard', __name__)


@app.route('/Registering_Data_when_Creating_a_New_Dashboard', methods = ['GET', 'POST'])
def index():
    ...
    return render_template('Registering_Data_when_Creating_a_New_Dashboard.html', designerJavaScript = js, designerHtml = html)
